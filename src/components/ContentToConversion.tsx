...
import { TrendingUp, PenTool, Zap, CheckCircle, ArrowRight, Users, MessageSquare, Eye } from 'lucide-react';
...
const ContentEngine = () => {
  ...
  return (
    <section id="content-engine" className="py-20 bg-gradient-to-br from-orange-50 via-amber-50 to-yellow-50">
