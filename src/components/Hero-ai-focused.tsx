  ...
  const features = [
    {
      ...
      description: "Transform videos with trending styles: professional, meme, funny, and cinematic themes",
    ...
    },
    {
      ...
      description: "AI-powered content that adapts to your audience and brand voice",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32 relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <motion.div 
                variants={fadeInUp}
                className="inline-flex items-center px-4 py-2 rounded-full text-sm font-medium bg-gradient-to-r from-violet-500/20 to-fuchsia-500/20 text-violet-200 backdrop-blur-sm border border-violet-500/20 mb-6 shadow-sm w-fit mx-auto lg:mx-0"
              >
              ...
              <motion.p 
                variants={fadeInUp}
                className="text-xl md:text-2xl text-gray-300 max-w-2xl mb-4 mx-auto lg:mx-0"
              >
                Revolutionizing digital marketing with AI-powered content creation tools.
              </motion.p>

              <motion.p 
                variants={fadeInUp}
                className="text-lg text-violet-300 font-medium mb-10 mx-auto lg:mx-0"
              >
                Experience advanced AI video editing, content generation, and marketing automation. AI Video Editor coming soon!
              </motion.p>
              ...
              >
                <button 
                  ...
                  className="px-8 py-4 bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-500 hover:to-cyan-500 text-white font-medium rounded-full shadow-lg hover:shadow-blue-500/25 transform hover:translate-y-[-2px] transition-all duration-300 flex items-center"
                >
                  Get Early Access
                  <ArrowRight className="ml-2 w-5 h-5" />
                </button>
                
                <Link to="/content-generator" className="px-8 py-4 bg-gradient-to-r from-violet-600 to-fuchsia-600 hover:from-violet-500 hover:to-fuchsia-500 text-white font-medium rounded-full shadow-lg hover:shadow-violet-500/25 transform hover:translate-y-[-2px] transition-all duration-300 flex items-center">
                  Try AI Tools
                  <ArrowRight className="ml-2 w-5 h-5" />
                </Link>
            ...
            >
              <div className="relative">
                ...
                <div className="absolute inset-0 bg-gradient-to-r from-violet-500/20 to-cyan-500/20 rounded-3xl blur-2xl transform scale-110"></div>
                ...
                <div className="relative bg-gradient-to-br from-gray-900/50 to-gray-800/50 backdrop-blur-sm rounded-3xl p-8 border border-white/10 shadow-2xl">
                  ...
                  {/* Floating badges */}
                  <div className="absolute top-4 right-4 bg-gradient-to-r from-blue-500 to-cyan-500 text-white px-3 py-1 rounded-full text-sm font-medium shadow-lg">
                    AI Powered
                  </div>
                  <div className="absolute bottom-4 left-4 bg-gradient-to-r from-violet-500 to-fuchsia-500 text-white px-3 py-1 rounded-full text-sm font-medium shadow-lg">
                    Coming Soon
                  </div>
                </div>
              </div>
            ...
            {features.map((feature, index) => (
              ...
              >
                ...
                {index === 0 ? (
                  <button 
                    onClick={handleEarlyAccessClick}
                    className="group flex items-center text-blue-400 font-medium"
                  >
                    Join Waitlist
                  ...
                  <Link 
                    ...
                    className="group flex items-center text-violet-400 font-medium"
                  >
                    Try Now
                    <ArrowRight className="ml-2 w-4 h-4 group-hover:translate-x-1 transition-transform" />
                  </Link>
